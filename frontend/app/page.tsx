...
interface WordData { word: string; pronunciation: string; type: string; meaning: string; example: string; image: string;}
                ...
                <div className="border border-gray-200 rounded-2xl p-4 flex flex-col md:flex-row gap-6 relative mb-8">
                    ...
                    <div className="flex-1 py-1">
                        <div className="flex justify-between items-start">
                            ...
                            <span className="bg-[#fef3c7] text-[#92400e] text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">Level {result?.level || 'Beginner'}</span>
                        </div>
